                            ...
                            <tbody>
                                @forelse($recentOrders ?? [] as $order)
                                    <tr>
                                        <td>{{ $order['id'] }}</td>
                                        <td>{{ $order['user_id'] }}</td>
                                        <td>Rp. {{ number_format($order['product_price'] ?? 0, 2) }}</td>
                                        <td>{{ $order['quantity'] ?? 0 }}</td>
                                        <td>Rp. {{ number_format(($order['product_price'] ?? 0) * ($order['quantity'] ?? 0), 2) }}
                                        </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter card-table table-striped" id="top-products-datatable">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">Tidak ada yang ditemukan</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
